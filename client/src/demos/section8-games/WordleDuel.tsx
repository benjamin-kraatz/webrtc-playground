...
const WORDS = [
  'ABEND','ADLER','ALTAR','ANGST','APFEL','ARMUT','AUDIO','BADEN','BANDE','BASIS',
  'BAUEN','BEIDE','BERGE','BERUF','BESEN','BLICK','BLOND','BODEN','BOGEN','BOHNE',
  'BRAND','BREIT','BRUCH','CHAOS','DAUER','DOLCH','DRAHT','DROGE','DUNST','EBENE',
  'EICHE','EILEN','EIMER','EINER','ENGEL','ENKEL','ERBEN','ERDEN','ERNST','ESSEN',
  'FABEL','FADEN','FALKE','FALLE','FARBE','FEDER','FEIER','FEIND','FERNE','FLECK',
  'FLORA','FLUSS','FOLGE','FORST','FRAGE','FRONT','FUCHS','FUNKE','GABEN','GARBE',
  'GEBEN','GEHEN','GENAU','GENRE','GERNE','GLANZ','GLEIS','GLIED','GRUND','HABEN',
  'HAGEL','HEBEN','HEFTE','HEIDE','HEUTE','HIRTE','KABEL','KADER','KAMIN','KANAL',
  'KANTE','KARST','KASSE','KERZE','KEULE','KISTE','KLAGE','KLANG','KLAUE','KLEID',
  'KLOTZ','KOHLE','KOMET','KONTO','KORAN','KRAUT','KREIS','KRIEG','KUNDE','KUNST',
];
